...
def create_knack_project_from_moped_project(moped_project_record, is_test=False, dry_run=True):
    """
    ...
    if dry_run:
        logger.debug(f"[DRY RUN] Would create Knack record: {knack_project_record}")
