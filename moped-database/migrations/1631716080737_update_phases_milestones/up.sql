...
UPDATE public.moped_phases SET phase_name = 'Post-construction', phase_description = 'Project is fully complete but pending actions or items to close it out', phase_order = 11, phase_average_length = null, required_phase = null, subphases = '{1}' WHERE phase_id = 10;
...
alter table moped_subphases drop constraint moped_subphases_subphase_name_key;
...
UPDATE public.moped_milestones SET milestone_name = 'Feasibilty study', milestone_description = null, milestone_order = 12, milestone_average_length = null, required_milestone = null, related_phase_id = 1 WHERE milestone_id = 12;
