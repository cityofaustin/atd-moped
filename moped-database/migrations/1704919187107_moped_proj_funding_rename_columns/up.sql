...
COMMENT ON TRIGGER update_moped_proj_funding_and_project_audit_fields ON moped_proj_funding IS 'Trigger to execute the update_self_and_project_updated_audit_fields function before each update operation on the moped_proj_funding table.';
