-- Drop new component geography view and revert to previous version of component_arcgis_online_view and exploded_component_arcgis_online_view
DROP VIEW IF EXISTS exploded_component_arcgis_online_view;
DROP VIEW IF EXISTS component_arcgis_online_view;
DROP VIEW IF EXISTS component_geography_view;
