...
-- Add new component geography view and update exploded_component_arcgis_online_view and component_arcgis_online_view to use it
-- This decouples the exploded view from the component_arcgis_online_view to avoid expensive queries of info not needed for the exploded view
...
FROM moped_proj_components mpc
LEFT JOIN component_geography_view comp_geography
    ON mpc.project_component_id = comp_geography.project_component_id
