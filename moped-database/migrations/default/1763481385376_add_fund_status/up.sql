...
COMMENT ON COLUMN public.ecapris_subproject_funding.program IS 'Timestamp when the record was created';
COMMENT ON COLUMN public.ecapris_subproject_funding.subprogram IS 'Timestamp when the record was created';
