...
COMMENT ON COLUMN ecapris_funding.ecapris_subproject_id IS 'eCapris subproject ID number (SP number)';
...
COMMENT ON COLUMN ecapris_funding.appropriated IS 'Appropriated amount (app field from Socrata)';
COMMENT ON COLUMN ecapris_funding.expenses IS 'Expenses (exp field from Socrata)';
COMMENT ON COLUMN ecapris_funding.obligated IS 'Obligated amount (obl field from Socrata)';
COMMENT ON COLUMN ecapris_funding.encumbered IS 'Encumbered amount (enc field from Socrata)';
...
SELECT
    ...
    NULL AS project_id,
    appropriated AS funding_amount,
