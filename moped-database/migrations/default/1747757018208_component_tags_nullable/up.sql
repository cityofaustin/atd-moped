...
CREATE OR REPLACE VIEW component_arcgis_online_view AS  WITH work_types AS (
         SELECT mpcwt.project_component_id,
         ...
         SELECT features.component_id AS project_component_id,
         ...
         SELECT feature_union.component_id AS project_component_id,
           ...
           FROM ( SELECT feature_signals.id,
                ...
                UNION ALL
                 SELECT feature_school_beacons.id,
         ...
         SELECT mpcs.project_component_id,
         ...
         SELECT mpct.project_component_id,
...
CREATE OR REPLACE VIEW exploded_component_arcgis_online_view AS  SELECT component_arcgis_online_view.project_id,
