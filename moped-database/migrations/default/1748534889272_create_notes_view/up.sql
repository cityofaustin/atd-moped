...
LEFT JOIN LATERAL (
    ...
    )) AND (combined_project_notes.project_note_type IN ('Status Update', 'eCapris Status Update'
...
-- TODO: Update AGOL view to reference latest status update depending on if eCapris sync is enabled or not
