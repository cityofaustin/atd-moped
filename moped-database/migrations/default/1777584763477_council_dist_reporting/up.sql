...
parent_child_project_map AS (
    ...
    SELECT
        ...
        array_to_string(array_agg(DISTINCT project_districts.council_district_id) FILTER (WHERE project_districts.council_district_id IS NOT null), ', ') AS project_council_districts_str,
        ...
        array_to_string(array_agg(DISTINCT project_and_children_districts.council_district_id) FILTER (WHERE project_and_children_districts.council_district_id IS NOT null), ', ') AS project_and_child_project_council_districts_str
