...
ALTER TABLE moped_proj_phases ALTER COLUMN phase_start TYPE timestamp WITH time zone,
...
UPDATE
    moped_proj_phases
SET
    phase_start = subquery.phase_start,
    phase_end = subquery.phase_end
FROM (
    SELECT
        project_id,
