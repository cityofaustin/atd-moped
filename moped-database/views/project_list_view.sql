...
parent_child_project_map AS (
    ...
    SELECT
        ...
        nullif(array_to_string(array_agg(DISTINCT project_districts.council_district_id ORDER BY project_districts.council_district_id), ', '::text), ''::text) AS project_council_districts_string,
        nullif(array_to_string(array_agg(DISTINCT project_and_children_districts.council_district_id ORDER BY project_and_children_districts.council_district_id), ', '::text), ''::text) AS project_and_child_project_council_districts_string
