...
docker-compose -f ../../database/docker-compose.yml -f ../../database/docker-compose.arm64.yml stop hasura
...
docker-compose -f ../../database/docker-compose.yml -f ../../database/docker-compose.arm64.yml up -d hasura
