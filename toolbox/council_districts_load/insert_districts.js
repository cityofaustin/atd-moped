/**
 * Loads council districts geojson into Moped
 */
const { HASURA_AUTH } = require("./secrets");
const fs = require("fs");

INSERT_DISTRICTS_MUTATION = `
mutation InsertCouncilDistricts($payload: [layer_council_district_insert_input!]!) {
  insert_layer_council_district(objects: $payload) {
    returning {
      id
    }
  }
