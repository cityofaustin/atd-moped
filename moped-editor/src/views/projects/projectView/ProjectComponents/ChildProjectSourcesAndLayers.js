...
/**
 * Component that renders feature collection of child project component features
 ...
 * @param {Object} childProjectComponentsFeatureCollection - GeoJSON feature collection with all project features
 * @param {Boolean} shouldShowRelatedProjects - should we show related projects
 * @returns JSX.Element
 */
const ChildProjectSourcesAndLayers = ({
  isCreatingComponent,
  isEditingComponent,
...
export default ChildProjectSourcesAndLayers;
