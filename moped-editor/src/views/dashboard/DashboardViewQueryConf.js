...
import { DashboardViewFiltersConf } from "./DashboardViewFiltersConf";
import { DashboardViewExportConf } from "./DashboardViewExportConf";
 ...
 * @constant
 * @type {object}
 * @augments DashboardViewFiltersConf
 * @default
 */
export const DashboardViewQueryConf = {
  options: {
    useQuery: {
  ...
  filters: DashboardViewFiltersConf,
  export: DashboardViewExportConf,
  search: {
    placeholder:
