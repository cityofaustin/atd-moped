...
* hasura.local.yaml: Template for the configuration which governs how `hasura-cluster` operates in local deployments for developers. A copy of this file ends up being deposited in the `database` directory with the name `config.yaml`.
