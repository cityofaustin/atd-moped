-- Most recent migration: database/migrations/default/1727229291111_add_beacons_to_unified_features_view/up.sql
...
SELECT
    ...
    json_build_object(
        ...
        'knack_id',
        feature_school_beacons.knack_id,
        'location_name',
        feature_school_beacons.location_name,
        'zone_name',
        feature_school_beacons.zone_name,
        'beacon_name',
        feature_school_beacons.beacon_name
    )                              AS attributes,
