-- Most recent migration: database/migrations/default/1742416187184_update_current_phase_view_drop_distinct_on/up.sql

CREATE OR REPLACE VIEW current_phase_view AS
SELECT
    mpp.project_id,
